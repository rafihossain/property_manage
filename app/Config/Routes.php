...
$routes->add('/', 'Admincontroller::index', ['as' => '/']);
...
$routes->group('admin', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->match(['get', 'post'],'poperty_list', 'Popertycontroller::popertyList', ['as' => 'poperty_list']);
    ...
    //floor section
    $routes->get('floor_list', 'Floorcontroller::index', ['as' => 'floor_list']);
    ...
    //Tenant section
    $routes->get('tenant_list', 'Tenantcontroller::index', ['as' => 'tenant_list']);
    ...
    //Maintenance section
    $routes->get('maintenance_list', 'Maintenancecontroller::index', ['as' => 'maintenance_list']);
 ...
 /*=============================================================
    ...
    $routes->match(['get', 'post'],'rentlist', 'Rentcontroller::rent_list', ['as' => 'rent_list']);
