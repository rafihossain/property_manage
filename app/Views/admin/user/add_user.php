                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img class="rounded-circle avatar-xs" alt="200x200" src="<?= base_url(); ?>/admin/assets/user/thumbnail/<?= $user['image']; ?>" data-holder-rendered="true"></td>
                                        <td><?= $user['name']; ?></td>
                                        <td><?= $user['email']; ?></td>
        ...
        $(document).on("click", ".view_user", function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var html = '';
                    if (indivisual_user.type == 1) {
                        var type = 'Super Admin';
                    } else if (indivisual_user.type == 2) {
                        var type = 'Admin';
                    } else if (indivisual_user.type == 3) {
                        var type = 'Owner';
                    } else if (indivisual_user.type == 4) {
                        var type = 'Employee';
                    } else if (indivisual_user.type == 2) {
                        var type = 'Tenent';
                    }
                    console.log(indivisual_user['owner_id']);

                    html = ' <div class="text-center"><img class="rounded-circle avatar-xl" alt="200x200" src="<?= base_url(); ?>/admin/assets/user/thumbnail/' + indivisual_user.image + '" data-holder-rendered="true"><h3>' + indivisual_user.name + '</h3></div><hr><h4><?= lang('setting/User_setup.userlist_detailsinfo'); ?></h4><div class="row"><div class="col-md-12"<?= lang('setting/User_setup.userlist_name'); ?>' + indivisual_user.name + '<br><?= lang('setting/User_setup.userlist_email'); ?>' + indivisual_user.email + '<br><?= lang('setting/User_setup.userlist_contact'); ?>' + indivisual_user.contactno + '<br><?= lang('setting/User_setup.userlist_branch'); ?>' + indivisual_user.branch + '<br><?= lang('setting/User_setup.userlist_pass'); ?>' + indivisual_user.password + '<br><?= lang('setting/User_setup.userlist_type'); ?>' + type + '</div></div>';
