                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-4">
                                        ...
                                        <select name="bill_type" id="bill_type" class="form-control" required>  
                                            ...
                                            <option value="Gas"<?php if($bill['bill_type']=='Gas'){echo "selected";}?>>Gas</option>
                                            <option value="Water"<?php if($bill['bill_type']=='Water'){echo "selected";}?>>Water</option>
                                            <option value="Electric"<?php if($bill['bill_type']=='Electric'){echo "selected";}?>>Electric</option>
                                          </select>
